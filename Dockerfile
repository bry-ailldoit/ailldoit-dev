...
ARG VITE_STRIPE_LIVE_PUBLIC_KEY
ARG VITE_STRIPE_LIVE_STARTER_PRICE_ID
ARG VITE_STRIPE_LIVE_GROWTH_PRICE_ID
...
ENV VITE_STRIPE_LIVE_PUBLIC_KEY=$VITE_STRIPE_LIVE_PUBLIC_KEY
ENV VITE_STRIPE_LIVE_STARTER_PRICE_ID=$VITE_STRIPE_LIVE_STARTER_PRICE_ID
ENV VITE_STRIPE_LIVE_GROWTH_PRICE_ID=$VITE_STRIPE_LIVE_GROWTH_PRICE_ID
